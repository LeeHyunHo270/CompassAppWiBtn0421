package com.example.compassappwibtn0421;
...
public class CompassActivity extends Activity {
    ...
    float[] magneticVaulues, accelValues;
        ...
        listener = new SensorEventListener() {
            ...
            public void onSensorChanged(SensorEvent event) {
                switch (event.sensor.getType()){
                    ...
                    break;
                    case Sensor.TYPE_MAGNETIC_FIELD:magneticVaulues = event.values.clone();
                    break;
                    default: break;
                }
                if(magneticVaulues !=null && accelValues !=null){
                    float[] R = new float[16];
                    float[] I = new float[16];
                    SensorManager.getRotationMatrix(R,I,accelValues,magneticVaulues);
